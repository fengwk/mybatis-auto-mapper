package fun.fengwk.automapper.processor.translator.sqlite;
 ...
 * @author fengwk
 */
public class SQLiteTranslator extends Sql92Translator {

    public SQLiteTranslator(TranslateContext translateContext) {
    ...
    protected String quoteIdentifier(String identifier) {
        String quote = resolveIdentifierQuote(DBType.SQLITE);
